"""Training script for segmented ICBHI data."""
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Train audio classification model on segmented data")
    parser.add_argument(
        "--config",
        type=str,
...
def main():
    ...
    # Print configuration
    print("\n" + "=" * 60)
    print("TRAINING CONFIGURATION (SEGMENTED DATA)")
    print("=" * 60)
